...
class qtype_comparetexttask extends question_type {
    ...
    public function get_question_options($question) {
        global $DB;
        $question->options = $DB->get_record('question_comparetexttask',
    ...
    public function save_question_options($question) {
        ...
        if ($existing = $DB->get_record('question_comparetexttask',
    ...
    public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('question_comparetexttask', array('question' => $questionid));
